...
@section('content')
  ...
  <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://images.unsplash.com/photo-1587805381148-21572e05f024?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1050&q=80'); background-repeat:no-repeat; background-size:cover; height:100%;">
  
    {{-- <div class="py-12">
      <h2 class="font-extrabold text-center text-6xl">Founder Of Geocipher</h2>
  </div>
   --}}
    <div class="max-w-4xl flex items-center pt-20 h-auto lg:h-screen flex-wrap mx-auto lg:my-0">
      
      {{-- both columns --}}
      <div class="both md:flex">
    <!--Main Col-->
  ...
  <div class="w-full lg:w-2/5">
      ...
      <img src="images/me3.jpg" alt="Michael Adetona" class="rounded-none lg:rounded-lg  shadow-2xl hidden lg:block">
      <!-- My Picture -->
      ...
      <!-- Pin to top right corner -->
        <div class="absolute top-20 right-40 h-12 w-18 p-4">
